# MODEL1310110034: MODEL1310110034
...
`pip install git+https://github.com/biomodels/MODEL1310110034.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL1310110034.git@20140916`

## Usage

Importing the model package.

`import MODEL1310110034 as model`
...
The model of hippocampus neuronal cells metabolism is derived from the
...
and identified by:
[MODEL1310110034](http://identifiers.org/biomodels.db/MODEL1310110034) .
